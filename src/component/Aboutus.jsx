...
const Aboutus = () => {
  ...
  return (
    <div>
      <section className="px-6 py-16 text-gray-800 bg-white lg:px-32">
        <h1 className="mb-6 text-4xl font-bold text-center fade-in-up">About Us</h1>

        <p className="max-w-3xl mx-auto mb-10 text-lg text-center text-gray-600 fade-in-up">
          At <span className="font-semibold text-red-500">FreshBites</span>, we believe food is more than just fuel — it's a connection to comfort, culture, and care...
        </p>

        <div className="max-w-5xl mx-auto leading-relaxed text-justify text-gray-700 space-y-14">
          {[
            {
              title: '🌱 Our Journey',
              content: [
                "Founded in 2020 by food lovers and nutrition advocates...",
                "What makes us different? Our commitment to real food..."
              ]
            },
            {
              title: '💡 What We Stand For',
              content: [
                <ul key="list" className="pl-6 space-y-2 list-disc">
                  <li><strong>Integrity:</strong> No shortcuts — just honest ingredients...</li>
                  <li><strong>Quality:</strong> We don’t compromise...</li>
                  <li><strong>Community:</strong> We partner with local farmers...</li>
                  <li><strong>Convenience:</strong> We know life is busy...</li>
                </ul>
              ]
            },
            {
              title: '👨‍🍳 Our Kitchen Promise',
              content: [
                "Each FreshBites meal is prepared in a certified, hygienic kitchen...",
                "Whether you're craving a hearty lunch or a light dinner..."
              ]
            },
            {
              title: '🌟 What Our Customers Say',
              content: [
                <p key="q1" className="italic text-gray-600">“FreshBites saved me from fast food..."</p>,
                <p key="q2" className="mt-2 italic text-gray-600">“As a busy developer, I don’t have time to cook...”</p>
              ]
            }
          ].map((section, i) => (
            <div key={i} ref={(el) => (sectionsRef.current[i] = el)} className="fade-section">
              <h2 className="mb-2 text-2xl font-semibold text-red-500">{section.title}</h2>
          ...
          <div className="mt-12 text-center fade-section" ref={(el) => (sectionsRef.current[4] = el)}>
            <h3 className="mb-2 text-2xl font-semibold text-red-500">Ready to taste the difference?</h3>
            <p className="mb-4 text-gray-700">
              Join over <span className="font-bold text-red-500">10,000+</span> happy customers...
            </p>
            <Link to="/section">
              <button className="px-6 py-3 mt-2 text-white transition bg-red-500 rounded hover:bg-red-600">
                Explore Our Menu
